...
Stylist.create(salon_id: 2, name: "Shaggy", birthdate: Date.new(1954,04,09), male_price: 40, female_price: 60, specialty: "nothing", photo_url: "http://upload.wikimedia.org/wikipedia/en/3/31/Shaggy11.jpg", email: "shaggy@gmail.com", rating_average: nil, starts_work_at: "12:00 p.m.", ends_work_at: "3:00 p.m.", day_off: "Wednesday", password: "abcd", password_confirmation: "abcd")

Stylist.create(salon_id: 2, name: "Scarlett", birthdate: Date.new(1985,12,09), male_price: 40, female_price: 60, specialty: "incredibleness", photo_url: "http://www.myfilmviews.com/wp-content/uploads/2012/12/scarlett_johansson.jpg", email: "scarlett@gmail.com", rating_average: nil, starts_work_at: "1:00 p.m.", ends_work_at: "9:00 p.m.", day_off: "Thursday", password: "abcd", password_confirmation: "abcd")
